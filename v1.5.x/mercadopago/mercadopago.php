...
class MercadoPago extends PaymentModule
{
    ...
    private function getPrestashopPreferencesStandard()
    {
        ...
        foreach ($products as $key => $product) {
            ...
            $tmp_fix_price += $item['unit_price'] * (int)$product['quantity'];
    ...
    public function createStandardCheckoutPreference()
    {
        ...
        if (Configuration::get('MERCADOPAGO_LOG') == 'true') {
            UtilMercadoPago::logMensagem('MercadoPago::createStandardCheckoutPreference()::$id = '.$id.', preferences: '. Tools::jsonEncode($preferences), MPApi::INFO);
        }
